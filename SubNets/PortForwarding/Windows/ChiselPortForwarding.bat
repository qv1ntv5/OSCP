::In some ocasions (this is specifically true on the exam enviroment), some machines on the internal network such as MS02 can't connect back with our kali. We have to do portforwarding through MS01 to make contact MS02 --> Kali.
